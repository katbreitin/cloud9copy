...
<div class="container">
   <div class="row">
      ...
      <div class="col-md-10">
         ...
         <div class="row">
            <div class="col-md-5">
               <img src="images/art/artists/medium/<?php echo $id;?>.jpg" class="img-thumbnail img-responsive" alt="" title="<?php echo $artist['FirstName'] . ' ' . $artist['LastName'];?>"/>
               
            </div>
            <div class="col-md-7">
               <p>
               <?php echo $artist['Details']; ?>
               </p>
               ...
               <div class="panel panel-default">
                 ...
                 <table class="table">
                   ...
                   <tr>
                     <th>More Info:</th>
                    <td><?php echo $artist['ArtistLink'];?></td>
                   </tr>    
                 </table>
               </div>                              
